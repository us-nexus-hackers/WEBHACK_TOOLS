...
Created By : \033[1;96mUS-NEXUS |\033[1;0m [V H3NTAI -V1]

\033[1;32m------------------------------------------   
\33[93m AUTHOR  : US NEXUS 
\33[93m GITHUB  : github.com/us-nexus-hackers
\33[93m TELEGRAM: https://t.me/usnexushacker
\033[1;32m------------------------------------------   
"""
os.system('clear')
print(logo)
...
def up_chker():
    ...
    if r != ver:
       ...
       os.system('xdg-open https://github.com/us-nexus-hackers')
       exit()
